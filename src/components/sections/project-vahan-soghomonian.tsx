...
const translations = {
  ...
  EN: {
    ...
    description: "This article on Vahan Soghomonian explores an artist whose multifaceted practice interweaves poetry, music, photography and installation. His universe navigates between Armenian heritage, personal narratives and sensitive experimentation. The project highlights a body of work deeply rooted in reality and imagination, between memory and contemporary creation.\n\nThis publication is based on an interview conducted with the artist, enriched by archives, documentary photographs and a bilingual French-Armenian layout. The editorial work questions artistic transmission through a hybrid format, between narrative and visual analysis.\n\nThe use of Armenian serves both as a tribute to the artist's heritage and a personal gesture, expressing a shared cultural connection and dialogue between memory and creation.",
  ...
  ՀԱՅ: {
    ...
    description: "Այս հոդվածը Վահան Սողոմոնյանի մասին ուսումնասիրում է՝ ամբողջացնելով պոեզիա, երաժշտություն, լուսանկարչություն և ինստալյացիա։ Նրա տիեզերքը շարժվում է հայ ժառանգության, անձնական պատմությունների և զգայական փորձերի միջև։ Նախագիծը լույս է նետում մի ստեղծագործության վրա, որը խորապես արմատավորված է իրականության և երևակայության մեջ, հիշողության և ժամանակակից ստեղծագործության միջև։\n\nԱյս հրատարակությունը հիմնված է արտիստի հետ անցկացված հարցազրույցի վրա՝ հարստացված արխիվներով, փաստաթղթային լուսանկարներով և ֆրանսերեն-հայերեն երկբեր նվազագրումով։ Խմբագրական աշխատանքը հարցնում է մեկնաբանական փոխանցման մասին՝ հիբրիդ ձևաչափի միջոցով, դրամա և տեսողական վերլուծության միջև։\n\nՀայերենի օգտագործումը ծառայում է ինչպես արտիստի ժառանգության տիտղոսին, այնպես էլ անձնական ժեստին, արտահայտելով համօրինակ մշակութային կապ և հիշողության ու ստեղծագործության միջև երկխոսություն։",
