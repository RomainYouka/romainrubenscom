...
<svg
  viewBox="0 0 26 14"
  role="img"
  aria-label="Romain Rubens"
  xmlns="http://www.w3.org/2000/svg"
  {...props}>

    <g fill="currentColor">
      <path d="M19.8425 0C21.0882 0 22.171 0.212891 23.0909 0.638477C24.0107 1.06426 24.7255 1.66152 25.2354 2.43027C25.7453 3.19902 26.0004 4.10439 26.0004 5.14629V5.64199H21.8951V5.54658C21.8951 4.82227 21.7208 4.26654 21.3723 3.87881C21.0237 3.49135 20.5169 3.29736 19.8521 3.29736C19.1807 3.29736 18.6693 3.49135 18.3175 3.87881C17.9657 4.26654 17.7899 4.82227 17.7899 5.54658V14H13.6846V5.14629C13.6846 4.09811 13.9412 3.18945 14.4544 2.42070C14.9675 1.65208 15.6855 1.05632 16.6086 0.633789C17.5317 0.211426 18.6095 0 19.8425 0Z" />
      <path d="M8.89453 9.33333H25.3156V6.66666H8.89453V9.33333Z" />
      <path d="M6.15801 0C7.39076 0 8.46864 0.211182 9.39177 0.633594C10.3147 1.05632 11.033 1.65186 11.5461 2.42070C12.0593 3.18945 12.3158 4.0979 12.3158 5.14629V14H8.21058V5.54658C8.21058 4.82217 8.03473 4.26641 7.68281 3.87881C7.33104 3.49135 6.81942 3.29736 6.14824 3.29736C5.48334 3.29736 4.97673 3.49135 4.62809 3.87881C4.27959 4.26641 4.10522 4.82217 4.10522 5.54658V14H0V5.14629C0 4.10439 0.254883 3.19902 0.764756 2.43027C1.27474 1.66152 1.99128 1.06416 2.91426 0.638477C3.83737 0.212891 4.91863 0 6.15801 0Z" />
    </g>
  </svg>;
